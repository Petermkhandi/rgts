...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    if (verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($errors)) {
            ...
            logActivity('admin', $admin_id, 'profile_updated', 'Name and email updated');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    if (verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($errors)) {
            ...
            logActivity('admin', $admin_id, 'password_changed', 'Password updated');
            ...
            <div class="card-body">
                <form method="POST" action="settings.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="new_password" id="adminPassword" class="form-control" required>
